...
const mainNewsTemplate = document.querySelector("#main-news-item");
const smallNewsTemplate = document.querySelector("#small-news-item");
...
smallNews.forEach((item) => {
  ...
  smallNewsContainer.appendChild(copyTemplate);
});
